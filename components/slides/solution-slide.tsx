      ...
      <div className="relative z-10 mt-8 grid w-full grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        >
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-blue-500/20 to-blue-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-blue-500/10">
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-green-500/20 to-green-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-green-500/10">
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-purple-500/20 to-purple-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-purple-500/10">
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-yellow-500/10">
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-teal-500/20 to-teal-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-teal-500/10">
          ...
          <motion.div
            ...
            className="group flex items-center gap-4 rounded-lg bg-gradient-to-r from-white/5 to-white/[0.02] p-4 backdrop-blur-sm transition-all duration-300 hover:from-white/8 hover:to-white/[0.03] hover:shadow-lg hover:shadow-purple-500/5"
          >
            <div className="rounded-full bg-gradient-to-br from-red-500/20 to-red-600/20 p-3 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-red-500/10">
        ...
        >
          ...
          <div className="grid gap-4">
            <motion.div
              ...
              className="group rounded-lg bg-gradient-to-r from-blue-500/10 to-blue-500/5 p-5 backdrop-blur-sm transition-all duration-300 hover:from-blue-500/15 hover:to-blue-500/10 hover:shadow-lg hover:shadow-blue-500/5"
            >
            ...
            <motion.div
              variants={featureVariants}
              className="group rounded-lg bg-gradient-to-r from-purple-500/10 to-purple-500/5 p-5 backdrop-blur-sm transition-all duration-300 hover:from-purple-500/15 hover:to-purple-500/10 hover:shadow-lg hover:shadow-purple-500/5"
            >
            ...
            <motion.div
              variants={featureVariants}
              className="group rounded-lg bg-gradient-to-r from-teal-500/10 to-teal-500/5 p-5 backdrop-blur-sm transition-all duration-300 hover:from-teal-500/15 hover:to-teal-500/10 hover:shadow-lg hover:shadow-teal-500/5"
            >
